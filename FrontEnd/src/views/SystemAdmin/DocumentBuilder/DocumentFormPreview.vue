<template>
  ...
  <div class="print-container min-h-screen bg-gray-100 dark:bg-gray-900 py-8" dir="rtl">
    ...
    <!-- The A4 Print Page -->
    <div v-else class="a4-page bg-white mx-auto shadow-2xl relative overflow-hidden flex flex-col" :class="template.orientation === 'landscape' ? 'landscape' : 'portrait'" id="print-area">
      ...
      <div class="relative z-10 p-12 flex-1 flex flex-col">
        ...
        <!-- Body -->
        <main class="flex-1 ck-content text-gray-900 leading-relaxed mb-12" v-html="replaceDynamicFields(template.body_content)"></main>
...
const loadTemplate = async () => {
  if (templateId === 'draft') {
    const draftStr = localStorage.getItem('document_builder_draft')
    if (draftStr) {
