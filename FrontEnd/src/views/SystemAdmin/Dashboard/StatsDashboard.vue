        ...
        <div class="grid gap-6 md:grid-cols-2">
          ...
          <div class="rounded-xl border border-gray-100 p-5 dark:border-gray-800 bg-gray-50/40 dark:bg-gray-900/30">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              عرض إجمالي المستخدمين النشطين، ومعدل العمليات في الثانية، ونشاط سير العمليات عبر الفروع المختلفة لحظياً.
            </p>
          </div>
          ...
          <div class="rounded-xl border border-gray-100 p-5 dark:border-gray-800 bg-gray-50/40 dark:bg-gray-900/30">
            <h5 class="font-bold text-gray-800 dark:text-gray-200 mb-2 flex items-center gap-2">
              <span class="h-2 w-2 rounded-full bg-blue-500"></span>
              إحصائيات إدخال وحفظ البيانات
            </h5>
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              مراقبة وتتبع جودة إدخال البيانات ومعدلات التعديل والحذف، للتأكد من انضباط مدخلي البيانات.
            </p>
          </div>
          ...
          <div class="rounded-xl border border-gray-100 p-5 dark:border-gray-800 bg-gray-50/40 dark:bg-gray-900/30">
            <h5 class="font-bold text-gray-800 dark:text-gray-200 mb-2 flex items-center gap-2">
              <span class="h-2 w-2 rounded-full bg-blue-500"></span>
              مخططات نمو القوى البشرية
            </h5>
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              استعراض المخططات البيانية الزمنية لنمو حجم القوة البشرية والإدارية الموزعة جغرافياً في النظام.
            </p>
          </div>
          ...
          <div class="rounded-xl border border-gray-100 p-5 dark:border-gray-800 bg-gray-50/40 dark:bg-gray-900/30">
            <h5 class="font-bold text-gray-800 dark:text-gray-200 mb-2 flex items-center gap-2">
              <span class="h-2 w-2 rounded-full bg-blue-500"></span>
              تقارير استهلاك الموارد السحابية
            </h5>
            <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              تتبع حجم التخزين المستهلك لقواعد البيانات والملفات المرفوعة، مع تصدير تقارير دورية للإدارة.
            </p>
          </div>
        </div>
      </div>
