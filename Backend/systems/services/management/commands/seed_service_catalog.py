...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        services = [
            ...
            {'code': '03', 'name_ar': 'استمارة بلوغ السن القانوني', 'description': 'تُستخدم عند بلوغ الفرد السن القانوني للتقاعد حسب الدليل.', 'category': 'military', 'icon': 'LogOut', 'form_type': 'retirement_age', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '09', 'name_ar': 'استمارة إثبات حالة وفاة', 'description': 'معاملة عاجلة لتوثيق الوفاة الطبيعية أو نتيجة حادث.', 'category': 'military', 'icon': 'HeartHandshake', 'form_type': 'death', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '08', 'name_ar': 'استمارة إثبات حالة مفقود', 'description': 'إثبات فقدان الفرد وفقاً للوائح المعتمدة.', 'category': 'military', 'icon': 'AlertOctagon', 'form_type': 'missing', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '22', 'name_ar': 'استمارة محال للتقاعد', 'description': 'إحالة الفرد إلى التقاعد بناءً على طلبه أو وفقاً للقرارات المعتمدة.', 'category': 'military', 'icon': 'FileText', 'form_type': 'retired', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '16', 'name_ar': 'استمارة عدم لياقة صحية', 'description': 'إثبات عدم لياقة الفرد الصحية بناءً على التقارير الطبية.', 'category': 'military', 'icon': 'Activity', 'form_type': 'medical_unfit', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '05', 'name_ar': 'استمارة إنهاء مدة', 'description': 'إنهاء خدمة الأفراد المتعاقدين بعد انتهاء مدة تعاقدهم.', 'category': 'military', 'icon': 'MapPin', 'form_type': 'end_of_service', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '07', 'name_ar': 'استمارة مسجون', 'description': 'تغيير حالة الفرد عند صدور حكم قضائي أو قرار رسمي بالحبس.', 'category': 'disciplinary', 'icon': 'ShieldAlert', 'form_type': 'imprisoned', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '17', 'name_ar': 'استمارة مرافق / معيات', 'description': 'تفريغ الفرد لمرافقة مريض أو بعثة رسمية.', 'category': 'military', 'icon': 'ExternalLink', 'form_type': 'escort', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '11', 'name_ar': 'استمارة مفرغ للدراسة', 'description': 'إثبات تفريغ الفرد للدراسة في جهة تعليمية.', 'category': 'military', 'icon': 'GraduationCap', 'form_type': 'study_leave', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '18', 'name_ar': 'استمارة منتدب', 'description': 'توثيق انتداب الفرد للعمل لدى جهة أخرى.', 'category': 'military', 'icon': 'Reply', 'form_type': 'seconded', 'service_type': 'form', 'approval_type': 'external'},
            {'code': '10', 'name_ar': 'استمارة شهيد', 'description': 'إثبات استشهاد الفرد وتحديث حالته في النظام.', 'category': 'military', 'icon': 'Binary', 'form_type': 'martyr', 'service_type': 'form', 'approval_type': 'external'},
