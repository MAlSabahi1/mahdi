    ...
    def get(self, request, *args, **kwargs):
        ...
        for idx, p in enumerate(qs, start=1):
            ...
            if report_id == 'report_5':
                ...
                row["escort_source"] = temp_details.get("escort_source", "غير مدخل")
                row["escort_name"] = temp_details.get("escort_name", "غير مدخل")
                row["duration_from"] = temp_details.get("duration_from", "غير مدخل")
                row["duration_to"] = temp_details.get("duration_to", "غير مدخل")
            elif report_id == 'report_7':
                row["delegate_to"] = temp_details.get("delegate_to", "غير مدخل")
                row["delegate_purpose"] = temp_details.get("delegate_purpose", "غير مدخل")
                row["duration_from"] = temp_details.get("duration_from", "غير مدخل")
                row["duration_to"] = temp_details.get("duration_to", "غير مدخل")
            elif report_id == 'report_8':
                row["study_type"] = temp_details.get("study_type", "غير مدخل")
                row["study_location"] = temp_details.get("study_location", "غير مدخل")
                row["duration_from"] = temp_details.get("duration_from", "غير مدخل")
                row["duration_to"] = temp_details.get("duration_to", "غير مدخل")
                ...
                row["verdict_type"] = temp_details.get("verdict_type", "غير مدخل")
                row["duration_from"] = temp_details.get("duration_from", "غير مدخل")
                row["duration_to"] = temp_details.get("duration_to", "غير مدخل")
                ...
                row["court_order"] = temp_details.get("court_order", "غير مدخل")
